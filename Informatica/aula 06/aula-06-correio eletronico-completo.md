...
recomendada a formalidade na comunicação; (III) Errado, compartilhar o histórico de uma conversa com alguém que não estava 
envolvido originalmente não é considerado uma boa prática de etiqueta. Ao responder a uma mensagem, é aconselhável não 
incluir toda a conversa anterior; inclua apenas o necessário para contextualizar os aspectos específicos aos quais você está 
respondendo ou comentando (Letra C). 
...
1 Especificação técnica que define o formato padrão de e-mails. 
Diego Carvalho, Renato da Costa, Equipe Informática e TI
Aula 06
TJs - Curso Regular (Analista Judiciário - Área Administrativa) Informática
www.estrategiaconcursos.com.br
...
chamado naotempraninguem@flamengoeomelhortimedomundo.com.br (Letra D). 
...
LISTA DE E-MAILS 
1 
contato.conselho@cra-ac.org.br 
21 
www@cra-ac.org.br 
2 
www.contato@cra-ac.org.br 
22 
contato@conselho@cra-ac.org.br  
3 
...
usuario.provedor.br@ 
27 
joaquim@empresa@com@br 
8 
www.joaquim@empresa.com. br 
28 
joaquim@empresa.com.br 
9 
http_joaquim.empresa.com.br 
29 
@joaquim.empresa.com.br 
10 
feliz.da.silva@@hotmail.com 
30 
nível@gmail.com 
11 
www.terra.com.br 
31 
jose da silva @yahoo.com.br 
12 
duvida@empresa1.com 
32 
\\maria\@tjsp.com.br 
...
maria@tjsp/com/br 
14 
http://maria@tjsp.com.br 
34 
maria@tjsp.com.br 
15 
www@email@com.br 
35 
fulano@empresa114.com.br 
16 
@fulano.industria.com.br 
36 
www.email.org 
17 
email.com.br 
37 
maria.sousa@provedor2.com 
18 
usuario$empresa.com.br 
38 
josé_b@lão@casadasogra.com.br 
19 
diego@carvalho.com.br 
39 
renatod@costa.com 
20 
flamengo@campeaodalibertadores.com 
40 
...
a) Remetente  
b) Anexo. 
         c) Spam                d) Servidor.          e) Destinatário. 
_______________________ 
...
destinatários em excesso, o endereço de destino não existe ou está incorreto, entre outros2. 
 
 
2 Nesses casos, em geral, uma resposta automática é enviada ao remetente informando o motivo para a não entrega do correio eletrônico. 
Diego Carvalho, Renato da Costa, Equipe Informática e TI
Aula 06
TJs - Curso Regular (Analista Judiciário - Área Administrativa) Informática
www.estrategiaconcursos.com.br
...
etiqueta da internet considera que – 
...
nenhuma resposta, isto é, apenas 
...
Trata-se de um recurso que permite que qualquer arquivo (documento, imagem, texto, etc) 
...
ou não –, observando o limite total de tamanho permitido pelo provedor de e-mail e tomando 
cuidado com arquivos executáveis, que podem conter softwares maliciosos (malwares).  
 
O anexo é armazenado no servidor de e-mails, logo – mesmo que o usuário faça o download do 
anexo para sua máquina e futuramente o exclua – nada acontece ao anexo contido no e-mail. 
...
Responder a todos 
Responder ao remetente original e a todos os destinatários que estejam em PARA e CC. 
Encaminhar 
...
Ele deveria utilizar a opção Responder (Reply-To) e, não, Responder a Todos (Reply-All). Dessa 
forma, apenas o remetente original da mensagem – analista judiciário – receberia a mensagem. 
Infelizmente, deu ruim para o nosso querido servidor público! Viram a importância do estudo de 
informática? Não cometam um vacilo desses! A Netiqueta recomenda que as mensagens de e-mail 
sejam formais, civilizadas e respeitosas. Lembrem-se: elas podem ser usadas contra vocês! 
...
outros destinatários que não estavam na lista de destinatários ou em cópia. Nesse caso, o 
remetente e os destinatários não são informados de que houve um encaminhamento da 
...
servidor de e-mail, logo webmails utilizam o Protocolo HTTP/HTTPS3. Por trás dos panos, o servidor 
...
3 Via de regra, utiliza o Protocolo HTTPS por conta da segurança, privacidade e autenticação, via login e senha. Caso não seja necessário, pode-se 
...
Recursos 
DESCRIÇÃO 
Desfazer Reverte a última ação realizada no e-mail. 
 
Refazer Refaz a última ação desfeita no e-mail. 
 
Fonte Seleciona o tipo de letra para o texto do e-mail. 
 
Tamanho Ajusta o tamanho da fonte do texto. 
 
Negrito Aplica formatação em negrito ao texto selecionado. 
 
Itálico Aplica formatação em itálico ao texto selecionado. 
 
Sublinhar Adiciona um sublinhado ao texto selecionado. 
 
Cor Altera a cor do texto ou da sua formatação. 
 
Alinhar Alinha o texto à esquerda, centro ou direita. 
...
FORMATAÇÃO
Inserir foto
Alternar Modo confidencial 
tAMANHO 
Inserir arquivos com Google drive 
Inserir assinatura 
refazer 
DESfazer 
Anexar 
...
Lista numerada Cria uma lista com números para cada item. 
 
Lista com 
marcadores 
Cria uma lista com marcadores (pontos) para cada item. 
 
Menor tabulação Diminui a indentação do texto. 
 
Maior tabulação Aumenta a indentação do texto. 
 
Remover 
formatação 
Remove toda a formatação aplicada ao texto. 
 
tachado Adiciona uma linha através do texto selecionado. 
 
citação Formata o texto como uma citação, com recuo e estilo diferenciado. 
 
enviar Envia o e-mail ao destinatário. 
 
Programar envio Agenda o envio do e-mail para uma data e hora específicas (esse recurso só é exibido ao clicar 
na setinha ao lado de Enviar). 
Opções de 
formatação 
Mostra mais opções de formatação de texto. 
 
Inserir Link Adiciona um hiperlink ao texto selecionado. 
 
Inserir Emoji Insere emojis no corpo do e-mail. 
 
Inserir arquivos 
com Google drive 
Anexa arquivos do Google Drive ao e-mail. 
 
Inserir foto Insere imagens no corpo do e-mail. 
 
Alternar Modo 
confidencial 
Ativa o modo confidencial para maior segurança. 
 
Inserir assinatura Adiciona uma assinatura predefinida ao e-mail. 
 
Descartar 
rascunho 
Exclui o rascunho do e-mail sem enviá-lo. 
...
Abrir e 
Exportar 
Permite abrir outros calendários (.ics, .vcs); permite abrir arquivos de dados do Outlook (.pst); permite 
...
criar assinaturas, entre outros. 
...
lixo eletrônico ou impedir que os itens enviados deste remetente, do domínio do remetente ou deste grupo 
...
encaminhamento deste item como um anexo ou uma mensagem de texto (SMS) ou a chamada do 
remetente deste item. 
 
Etapas Rápidas 
Permite automatizar diversas ações, tais como mover uma mensagem para uma pasta específica e marcá-
la como lida ou encaminhar uma mensagem para seu gerente. 
...
lembrar de acompanhar este item posteriormente (os itens sinalizados aparecem na barra de tarefas 
...
1 Em alguns casos, você ainda poderá até recuperar itens após a pasta Itens Excluídos ser esvaziada. O e-mail é excluído automaticamente da pasta 
...
desmarcar o cabeçalho de uma mensagem para que não seja baixado; e permite baixar o conteúdo de todos 
...
mensagens sinalizadas para acompanhamento e e-mails não lidos). 
...
remover as mensagens redundantes de todas as conversas da pasta selecionada; permite excluir todos os 
...
editar permissões de compartilhamento da pasta; exibe as propriedades da pasta. 
...
configurações de modo de exibição avançadas. Elas incluem adição e remoção de campos, agrupamento, 
classificação, filtragem, formatação de colunas e outras configurações; permite redefinir todas as 
configurações do modo de exibição atual conforme as configurações padrão da pasta. 
...
exibição atual; permite escolher os campos que serão mostrados no modo de exibição; permite expandir 
...
pendentes e escolher o que será mostrado. 
...
Ajuda e 
Suporte 
Exibe uma opção de ajuda; permite sugerir novos recursos para o Outlook; exibe treinamento de uso do 
software. 
Diego Carvalho, Renato da Costa, Equipe Informática e TI
Aula 06
TJs - Curso Regular (Analista Judiciário - Área Administrativa) Informática
...
DESCRIÇÃO 
ATALHO 
Nova Mensagem (Todos os Modos de Exibição)
CTRL + SHIFT + M 
Nova Mensagem (Modo de Exibição de E-Mail)
CTRL + N 
Verificar se existem novas mensagens
CTRL + M ou F9 (ESSE CAI MUITO EM PROVA!!!) 
...
CTRL + SHIFT + V 
Ir para a Caixa de Pesquisas
CTRL + E ou F3 
Abrir a Guia Arquivo
ALT + F 
Ir para Diga-me
ALT + G 
Move mensagens atuais e futuras para os Itens Excluídos
CTRL + DEL 
Remove as conversas redundantes da conversa ou pasta
ALT + DEL 
...
1 É possível fazer backup local de perfil (em um pendrive, por exemplo). 
Diego Carvalho, Renato da Costa, Equipe Informática e TI
Aula 06
TJs - Curso Regular (Analista Judiciário - Área Administrativa) Informática
www.estrategiaconcursos.com.br
...
Novo e-mail 
CTRL + M ou CTRL + N 
Abre um e-mail (em uma nova aba) 
CTRL + O 
Fecha uma aba 
CTRL + W 
Edita um e-mail 
...
Imprime um e-mail 
CTRL + P 
Acessa a próxima mensagem não lida 
N 
Localizar na página  CTRL + F 
Seleciona todas as mensagens 
CTRL + A 
Abre o catálogo de endereços  CTRL + SHIFT + B 
Atualiza a caixa de e-mail selecionada 
F5 
Atualiza todas as caixas de e-mail selecionadas 
SHIFT + F5 
...
1. (CESGRANRIO / BB – 2023) Uma situação que ocorre no dia a dia da utilização de correio 
eletrônico é uma pessoa A (emissor), após enviar uma mensagem X para uma outra pessoa B 
(destinatário), receber uma resposta automática que informa que a caixa de correio do 
destinatário está cheia. Isso significa que a(o): 
 
a) espaço ocupado por mensagens na caixa de correio do destinatário atingiu o limite 
autorizado. 
...
e) espaço ocupado pela mensagem X é muito grande, e seu envio não foi autorizado pela 
infraestrutura do emissor. 
 
Comentários: 
 
Isso significa que o espaço ocupado por mensagens na caixa de correio do destinatário atingiu o 
limite autorizado. Quando a caixa de correio de um destinatário está cheia, significa que o espaço 
alocado para armazenar mensagens atingiu seu limite máximo. Isso pode impedir a entrega de 
novas mensagens até que o destinatário libere espaço excluindo mensagens antigas ou fazendo 
outras ações para liberar espaço de armazenamento. 
 
As demais opções não são a causa típica de uma resposta automática informando que a caixa de 
correio do destinatário está cheia. É importante notar que as respostas automáticas de caixas de 
correio cheias variam, e a linguagem exata da mensagem pode depender da configuração do 
serviço de e-mail utilizado. 
 
Gabarito: Letra A 
 
2. (CESGRANRIO / BASA – 2022) A importante contribuição na evolução dos processos 
organizacionais, que o avanço da Tecnologia da Informação proporciona, acarreta, 
concomitantemente, a necessidade de um maior cuidado com questões referentes à segurança 
da informação. Evitar ataques aos sistemas de correio eletrônico é um dos objetivos dos 
especialistas em segurança. Um conhecido ataque que pode ser feito por e-mail é o spoofing. 
...
(a) Correto. Denunciar um e-mail como spam é a maneira mais eficaz de informar ao Gmail que você 
suspeita que um e-mail pode ser uma tentativa de spoofing ou outra forma de e-mail fraudulento. 
Isso o ajuda a aprender e aprimorar o filtro de spam, além de remover o e-mail da caixa de entrada; 
 
(b) Errado. Gerenciar marcadores no Gmail é uma forma de organizar e-mails, mas não tem relação 
direta com a denúncia de e-mails suspeitos de spoofing; 
 
(c) Errado. Marcando um e-mail como estrela no Gmail serve para destacar e-mails importantes ou 
para leitura posterior, não estando relacionado à segurança ou à denúncia de spoofing; 
 
(d) Errado. Movendo um e-mail para a lixeira simplesmente exclui o e-mail da caixa de entrada, mas 
não informa ao Gmail que o e-mail é suspeito de ser spoofing; 
 
(e) Errado. Trata-se de uma funcionalidade usada para saber se o destinatário leu o e-mail enviado, 
mas não é uma ferramenta para denunciar ou identificar e-mails suspeitos de spoofing. 
 
Gabarito: Letra A 
 
3. (CESGRANRIO / CEF – 2021) O aplicativo de correio eletrônico pode ser configurado para enviar 
mensagens e acessar as caixas de mensagens que estão no servidor de correio. Um dos 
protocolos de comunicação mais utilizados para acessar as mensagens da caixa de entrada é o: 
...
(a) Errado. Ele é usado principalmente para enviar e-mails, não para acessar mensagens da caixa de 
entrada; 
 
(b) Correto. Ele é usado para acessar e-mail em um servidor de correio, permitindo que os usuários 
vejam/manipulem suas mensagens como se estivessem armazenadas localmente; 
...
(c) Errado. SMB (Server Message Block) é um protocolo de rede para compartilhamento de 
arquivos, não está relacionado ao e-mail; 
 
(d) Errado. SSH (Secure Shell) é um protocolo usado para operações seguras de rede, como acesso 
remoto a servidores, mas não para acessar e-mails; 
 
(e) Errado. RDP (Remote Desktop Protocol) é um protocolo para conexões de área de trabalho 
remota, não está relacionado ao acesso de e-mail. 
 
Gabarito: Letra B 
 
4. (IBFC / MGS – 2022) Assinale a alternativa que preenche corretamente a lacuna. Em muitos 
aplicativos de Correios Eletrônicos aparece a abreviatura em Língua Portuguesa: “CCo”. Ao 
utilizar desse recurso permite _____________. 
 
a) que todos que recebam o e-mail, consigam ver o endereço de quem mais o recebeu 
b) encaminhar um e-mail para mais de uma pessoa, sem que ela saiba que a outra esteja 
recebendo a mesma mensagem 
c) acompanhar o e-mail, sabendo se o destinatário efetivamente recebeu a mensagem 
encaminhada 
d) que seja utilizado para apagar o e-mail encaminhado, depois que o emissário enviou por erro 
 
Comentários: 
 
(a) Errado, o recurso que permite que todos vejam o endereço de quem receber é o PARA ou CC; (b) 
Correto, o CCO é a cópia oculta, ou seja, ele não é visível para os outros destinatários da mensagem; 
(c) Errado, para acompanhar a chegada de um e-mail é possível utilizar recibos de entrega; (d) 
Errado, não há como apagar um e-mail que já foi recebido. 
              
Gabarito: Letra B 
 
5. (REIS&REIS / PREFEITURA DE POTIM-SP – 2022) Vitória quer enviar um e-mail utilizando sua 
conta no Gmail, para um grupo de dez pessoas, de modo que nenhum membro do grupo possa 
descobrir quem são os demais membros. Uma solução prática para isso é: 
 
a) Cadastrar contatos imaginários com os e-mails de todos os destinatários. 
b) Colocar toda a lista de destinatários como Cc. 
c) Criptografar a lista de destinatários do e-mail. 
d) Colocar toda a lista de destinatários como Cco.   
 
Comentários: 
 
Para enviar um e-mail para dez destinatários diferentes sem que nenhum saiba o endereço dos 
outros, é necessário colocar os endereços dos destinatários como cópias ocultas (CCO). 
Diego Carvalho, Renato da Costa, Equipe Informática e TI
Aula 06
TJs - Curso Regular (Analista Judiciário - Área Administrativa) Informática
www.estrategiaconcursos.com.br
...
6. (AVANÇA SP / PREFEITURA DE LOUVEIRA-SP – 2022) “Refere-se à prática de enviar uma 
mesma mensagem a vários destinatários de tal maneira que eles não conheçam uns aos outros.” 
...
Trata de uma cópia oculta – também conhecida como CCO. 
              
Gabarito: Letra A 
 
7. (CESGRANRIO / Banco do Brasil – 2021) O envio e o recebimento de mensagens de correio 
eletrônico são atividades corriqueiras, tanto nas organizações quanto no dia a dia da grande 
maioria da população brasileira. No entanto, há situações em que as mensagens enviadas são 
devolvidas com um aviso de que não puderam ser entregues ao destinatário. Um dos motivos 
que justificam a não entrega de uma mensagem de correio eletrônico ao destinatário é porque: 
...
(a) Errado. O estado da estação de trabalho do destinatário (ligada ou desligada) não influencia a 
entrega de e-mails; 
 
(b) Correto. Se a caixa de correio eletrônico do destinatário atingir o limite de tamanho, as 
mensagens subsequentes não poderão ser entregues, resultando em um erro de entrega; 
...
(c) Errado. Ter muitos endereços de e-mail cadastrados não é um motivo para a não entrega de e-
mails, a menos que haja um erro específico no endereço usado; 
 
(d) Errado. A utilização ou não da estação de trabalho pelo destinatário no momento do 
recebimento não interfere na entrega do e-mail; 
 
(e) Errado. O uso de vários programas na estação de trabalho do destinatário não afeta a entrega 
de e-mails. 
              
Gabarito: Letra B 
 
 
8. (CESGRANRIO / Banco do Brasil – 2021) O serviço de correio eletrônico é uma ferramenta 
...
9. (IDIB / Ministério da Economia – 2021) Uma das primeiras aplicações utilizadas na Internet foi 
...
10. (IDIB / Ministério da Economia – 2021) Como a aplicação de e-mail é assíncrona, é possível 
...
15. (IBFC / PM-SE – 2018) Quanto aos principais e mais conhecidos protocolos específicos de e-
...
16. (ESAF / ANAC – 2018) A especificação do destinatário em Correio Eletrônico é um string 
...
17. (CESGRANRIO / Banco da Amazônia – 2018) Está sintaticamente correto o seguinte endereço 
de e-mail: 
...
(a) Errado. O endereço "vendas?Consultas.example.com.@.br" é inválido devido ao uso de 
caracteres inapropriados (? e @) e à estrutura incorreta; 
 
(b) Correto. O endereço "vendas@consultas.example.com.br" segue a sintaxe correta de um 
endereço de e-mail, com um nome de usuário seguido do símbolo "@" e do domínio do e-mail; 
 
(c) Errado. O endereço "@vendas@consultas@example.com.br" é inválido devido à presença de 
múltiplos caracteres "@" e à estrutura geral incorreta; 
 
(d) Errado. O endereço "vendas.consultas.example.com.br" não possui o símbolo "@", que é 
essencial na estrutura de um endereço de e-mail válido; 
 
(e) Errado. "vendas@online@consultas.example.com.br" é inválido devido à presença de múltiplos 
caracteres "@". 
...
18. (IDIB / CRO BA – 2017) Acerca do correio eletrônico na língua portuguesa - que é visualizado 
...
19. (INAZ do Pará / Pref. Rolim de Moura - 2017) O correio eletrônico continua sendo a principal 
...
20. (IBADE / PC AC - 2017) O correio eletrônico, também conhecido como e-mail, é um programa 
...
21. (IESES / Prefeitura de São José do Cerrito – 2017) Para encaminhar a cópia de uma mensagem 
...
22. (UFPEL / UFPEL / 2016) Considere as afirmativas a seguir: 
...
23. (INAZ do Pará / CRO RJ - 2016) Em virtude dos avanços tecnológicos, surgiram vários meios de 
...
24. (INAZ do Pará / CREFITO 12 - 2016) O correio eletrônico é muito utilizado para troca de e-mails. 
...
25. (UFMT / Prefeitura de Rondonópolis – 2016) Os serviços de e-mail da Internet usam pastas 
...
26. (CESGRANRIO / ANP – 2016) Para prevenir que vírus se instalem nos computadores de seus 
...
Gabarito: Letra E 
27. (QUADRIX / CFB – 2016) No Microsoft Outlook 2013 é possível criar um conjunto de regras para 
...
28. (FEPESE / SAP/SC – 2016) Assinale a alternativa com a extensão que possibilita integrar a 
...
29. (QUADRIX / CRM/DF – 2015) No modo de exibição E-mail do Outlook 2016, as teclas de atalho 
...
30. (CESGRANRIO / Banco do Brasil – 2015) O gerente de uma agência recebeu um e-mail, 
...
31. (AOCP / FUNDASUS – 2015) Acerca dos conceitos e fundamentos básicos da internet, a 
...
32.  (FUNRIO / INSS – 2014) Analise as seguintes afirmações sobre os campos de destinatários de 
...
33. (CONSULPLAN / Prefeitura de Natividade – 2014) São algumas formas de endereçamento de 
...
34. (FUNCAB / PRODAM-AM – 2014) Sobre manipulação de mensagens em aplicativos de correio 
...
35. (FUNCAB / PC-RO – 2014) Suponha que você tenha recebido em sua Caixa de Entrada a 
...
36. (CESGRANRIO / Banco do Brasil – 2014) Qual arquivo que, por questões de segurança, não 
pode ser enviado para terceiros através do Gmail diretamente anexado ao email? 
Diego Carvalho, Renato da Costa, Equipe Informática e TI
Aula 06
TJs - Curso Regular (Analista Judiciário - Área Administrativa) Informática
www.estrategiaconcursos.com.br
...
37. (CESGRANRIO / PETROBRAS – 2014) Uma funcionária deseja enviar, a partir de seu e-mail de 
...
38. (UFPEL / UFPEL / 2013) Os softwares de navegação e de correio eletrônico devem suportar o 
...
39. (AOCP / Colégio Pedro II – 2013) Com relação a Spam no ambiente de internet, assinale a 
alternativa correta: 
...
40. (QUADRIX / CRF-RS – 2013) No envio e recebimento de mensagens de correio eletrônico, seja 
...
41. (FUNDEP / CONDEMIG – 2013) Os e-mails não solicitados e enviados para um grande número 
...
42. (CONSULPLAN / BANESTES  – 2013) O e-mail é um recurso muito utilizado pelas empresas por 
...
43. (COVEST-COPSET / UFPE – 2013) Para se enviar com sucesso uma mensagem de correio 
...
44. (ESPP / MPE-PR – 2013) Identifique quais itens abaixo que são tipicamente utilizados em 
...
45. (CESGRANRIO / IBGE – 2013) Os softwares usados para envio de e-mails disponibilizam um 
...
46. (UFPEL / UFPEL / 2012) São exemplos de “comunicador instantâneo” e “cliente de e-mail”, 
respectivamente: 
...
47. (OBJETIVA / EPCT - 2012) A comunicação por e-mail tornou-se, nos últimos anos, um dos canais 
...
48. (SOUSÂNDRADE / EMAP – 2012) Levando em consideração conceitos sobre internet e email, 
...
49. (ESAF / Ministério da Fazenda – 2012) O Correio Eletrônico é um método que permite compor, 
...
50. (CESGRANRIO / TRANSPETRO – 2012) Um usuário pode enviar um arquivo anexado a uma 
...
51. (CESGRANRIO / PETROBRAS – 2012) Bruno enviou um email com o seguinte cabeçalho: 
...
Quando um destinatário responde a um e-mail, o programa de e-mail geralmente inclui o 
remetente original (De:) e todos os destinatários nos campos Para: e Cc: no cabeçalho da resposta. 
Diego Carvalho, Renato da Costa, Equipe Informática e TI
Aula 06
TJs - Curso Regular (Analista Judiciário - Área Administrativa) Informática
www.estrategiaconcursos.com.br
...
No entanto, os destinatários no campo Cco: (cópia oculta) não são visíveis para outros destinatários 
e, portanto, não são incluídos automaticamente nas respostas. 
 
Neste caso, Dalila pode ver os endereços de Bruno (De:), Carlos (Para:) e o próprio endereço dela 
(Cc:). Ela não tem conhecimento dos destinatários Cco: (Ana e Edson) apenas olhando para o 
cabeçalho do e-mail que recebeu. Assim, se Dalila responder a todos que ela pode identificar no 
cabeçalho da mensagem, a resposta será enviada para: 
 
▪ Bruno, que é o remetente original; 
▪ Carlos, que é outro destinatário no campo para: 
 
Os destinatários em cópia oculta (Ana e Edson) não serão incluídos na resposta de Dalila, visto que 
ela não tem conhecimento deles. 
 
Gabarito: Letra B 
 
52. (CESGRANRIO / PETROBRAS – 2012) A vantagem de usar o protocolo IMAP em lugar do 
...
53. (CONSULPLAN / CM-SAG – 2011) Sobre a utilização de aplicativos gerenciadores de correio 
...
54. (CESGRANRIO / PETROBRAS – 2011) Um navegador é um software de computador que 
...
55. (CESGRANRIO / PETROBRAS – 2010) Os provedores de Internet disponibilizam a seus usuários 
...
56. (CESGRANRIO / IBGE – 2009) Paulo deseja enviar uma mensagem de correio eletrônico para 
...
57. (CESGRANRIO / IBGE – 2009) Com base na figura abaixo, analise as afirmativas seguintes. 
...
58. (CESGRANRIO / IBGE – 2009) Na Internet, e-mail é um recurso que permite ao usuário: 
...
59. (CESGRANRIO / TERMOMACAÉ – 2009) Uma das vantagens das ferramentas de Webmail 
...
60. (UFPEL / UFPEL / 2008) Pode-se verificar se um e-mail foi efetivamente enviado clicando em: 
...
61. (CESGRANRIO / CEF – 2008) Considere um endereço eletrônico de destino abcd@efgh.com. 
...
62. (CESGRANRIO / ANP – 2008) A vantagem de se utilizar um serviço de webmail em relação ao 
...
63. (CESGRANRIO / CAPES – 2008) Luiz enviou um e-mail para Ana, com cópia para Beatriz e cópia 
...
64. (CESGRANRIO / IBGE – 2006) Marque a opção que apresenta um endereço de e-mail: 
...
65. (CESGRANRIO / IBGE – 2006) Suponha que um e-mail será enviado para os seguintes 
...
66. 
(CESGRANRIO / IBGE – 2006) O protocolo utilizado no correio eletrônico para o envio de 
...
1. (CESPE / TCE-AC – 2024) No Microsoft Outlook, é possível selecionar aleatoriamente diversas 
mensagens da caixa de entrada, usando-se a tecla 
, para copiá-las para outra pasta. 
 
Comentários: 
 
A tecla SHIFT no Microsoft Outlook é usada para selecionar um intervalo contínuo de mensagens, 
e não de forma aleatória. Para selecionar mensagens de maneira não sequencial, deve-se utilizar a 
tecla CTRL. Assim, a afirmação está incorreta. 
 
Gabarito: Errado 
 
2. (CESPE / Prefeitura de Cachoeiro de Itapemirim-ES – 2024) No MS Outlook, ao se fazer uma 
cópia de segurança de todas as informações de contato, calendário e e-mail para um arquivo do 
tipo pst, os anexos de e-mail são excluídos. 
 
Comentários: 
 
A afirmação está incorreta. Ao exportar dados do Microsoft Outlook para um arquivo .pst, todas as 
informações, incluindo e-mails, contatos, calendário e anexos, são preservadas. O arquivo .pst 
funciona como um backup completo da conta configurada no Outlook. 
 
Gabarito: Errado 
 
 
3. (CESPE / CAU-BR – 2024) No Outlook, a opção Inserir Assinatura permite que a mensagem de 
email seja assinada digitalmente com uso de criptografia. 
 
Comentários: 
 
Errado. A opção Inserir Assinatura no Outlook permite adicionar uma assinatura personalizada 
com texto, imagens ou links ao final do e-mail. Para assinar digitalmente com criptografia, é 
necessário utilizar um certificado digital e a opção Assinatura Digital, disponível nas 
configurações de segurança do Outlook. 
 
Gabarito: Errado 
 
4. (CESPE / CAU-BR – 2024) No Microsoft Outlook, é possível anexar a uma mensagem de correio 
eletrônico um documento que está na nuvem, usando-se, para tanto, o recurso OneDrive. 
...
Correto. O Microsoft Outlook permite anexar documentos armazenados na nuvem, incluindo 
arquivos do OneDrive. Ao invés de enviar um anexo tradicional, o Outlook insere um link para o 
arquivo na nuvem, facilitando o compartilhamento e a colaboração em tempo real. 
 
Gabarito: Correto 
 
5. (CESPE / CAU-BR – 2024) O Microsoft Outlook permite gerenciar agenda de compromissos e 
de contatos do usuário. 
 
Comentários: 
 
Correto. O Microsoft Outlook não é apenas um cliente de e-mail, mas também oferece recursos 
para gerenciamento de agenda e contatos. Ele permite criar, editar e gerenciar compromissos, 
além de armazenar informações detalhadas sobre contatos, como e-mails, telefones e endereços. 
 
Gabarito: Correto 
 
6. (CESPE / CAU-BR – 2024) No Outlook, a opção Inserir Assinatura permite que a mensagem de 
email seja assinada digitalmente com uso de criptografia.   
...
7. (CESPE / PM-SC – 2023) Para o envio de dois arquivos, um de texto e outro com uma planilha, 
por correio eletrônico, é correto utilizar o aplicativo 
 
a) Edge, clicar a opção e-mail, encaminhar inicialmente o arquivo de texto e, em seguida, enviar 
o arquivo da planilha. 
b) Outlook, clicar a opção Novo Email, anexar os dois arquivos, digitar o endereço de destino e 
enviar a mensagem. 
...
(a) Errado. Edge é um navegador da web, não um cliente de e-mail dedicado. Embora possa acessar 
serviços de e-mail, a descrição não é a mais adequada para enviar arquivos por e-mail; 
 
(b) Correto. É possível anexar múltiplos arquivos, escrever o endereço de destino e então enviar a 
mensagem. Esta é a forma mais eficiente de enviar arquivos de texto e planilhas por e-mail; 
 
(c) Errado. Safari é um navegador web, não é um aplicativo de e-mail, e a segurança mencionada 
não está diretamente relacionada ao envio de arquivos de texto e planilhas; 
 
(d) Errado. Chrome é um navegador da web e, embora possa acessar serviços de e-mail, não é um 
cliente de e-mail dedicado como o Outlook; 
 
(e) Errado. Firefox, semelhante ao Chrome e Safari, é um navegador da web e não é especializado 
no envio de e-mails com arquivos anexados. 
 
Gabarito: Letra B 
 
8. (CESGRANRIO / AgeRIO – 2023) Ao enviar uma mensagem de correio eletrônico para um 
destinatário, por meio, por exemplo, do Microsoft Outlook, é possível enviar cópias dessa 
mesma mensagem para outros destinatários. Considere que uma pessoa P1 enviou uma 
mensagem para uma pessoa P2, com cópia para uma pessoa P3 e com cópia oculta para uma 
pessoa P4. Nesse cenário, uma vez que essa mensagem tenha sido enviada e recebida por todos, 
...
(a) Errado. P2 saberá que P1 foi o remetente, mas também poderá ver que uma cópia foi enviada 
para P3 (campo Cc); (b) Errado. P3 não terá como saber que P4 recebeu uma cópia, pois P4 está em 
cópia oculta (Bcc); (c) Correto. Todos receberão a mensagem de P1. P2 e P3 verão um ao outro no 
campo Cc, mas não verão P4, que está em Bcc; (d) Errado. P4 saberá que P1 foi o remetente e verá 
quem são os destinatários no campo Para e Cc, mas não terá informações sobre outras cópias 
ocultas; (e) Errado. P4 saberá que P1 é o remetente e verá as informações dos destinatários no 
campo Para e Cc. 
...
9. (CESPE / Prefeitura de Boa Vista-RR - 2023) No Outlook, a opção utilizada para adicionar um 
...
(a) Errado. "Criar Novo E-mail" é utilizado para iniciar a composição de uma nova mensagem de e-
mail, mas por si só não serve para adicionar um arquivo. 
 
(b) Errado. "Enviar" é a opção usada para enviar a mensagem de e-mail depois de composta, mas 
não é a opção para adicionar anexos. 
 
(c) Correto. "Anexar" é a opção correta para adicionar arquivos a uma mensagem de e-mail. Com 
essa opção, o usuário pode escolher arquivos de seu computador ou outras fontes. 
 
(d) Errado. "Adicionar um Assunto" é utilizado para inserir o assunto do e-mail, mas não está 
relacionado à inclusão de arquivos anexados. 
 
Gabarito: Letra C 
 
10. (CESPE / CNMP - 2023) Caso se deseje anexar um arquivo de texto, vídeo ou imagem a uma 
...
11. (CESPE / Prefeitura de São Cristovão-SE - 2023) O software de correio eletrônico do pacote 
...
(a) Correto. O Microsoft Outlook é o software de correio eletrônico do pacote Microsoft Office 365, 
permitindo o envio e recebimento de e-mails, além de gerenciamento de contatos, calendário e 
tarefas; (b) Errado. O Microsoft Teams é uma ferramenta de comunicação e colaboração, utilizada 
para videoconferências, chats e compartilhamento de arquivos, mas não é um cliente de e-mail; (c) 
Errado. O Microsoft Access é um sistema de gerenciamento de banco de dados, não um software 
de correio eletrônico; (d) Errado. O Microsoft Edge é um navegador de internet, utilizado para 
acessar páginas web. 
 
Gabarito: Letra A 
 
12. (CESPE / AGER-MT - 2023) No Outlook, é possível enviar cópias de uma mensagem de email 
...
(a) Errado. A opção "Contatos" é usada para selecionar destinatários a partir da lista de contatos, 
mas não esconde os destinatários adicionais. 
 
(b) Errado. "Para" é o campo principal para adicionar destinatários, mas todos os endereços 
incluídos aqui são visíveis para todos os destinatários. 
 
(c) Errado. "Cc" (carbon copy) permite enviar cópias do e-mail para outros, mas os endereços 
incluídos são visíveis para todos os destinatários. 
...
(d) Correto. "Cco" (cópia oculta) é usado para enviar cópias do e-mail sem revelar os endereços dos 
destinatários adicionais para o destinatário principal ou para outros incluídos no e-mail. 
 
(e) Errado. "Agendar enviar e-mail" permite programar um horário para o envio do e-mail, mas não 
tem relação com a visibilidade dos destinatários. 
              
Gabarito: Letra D 
 
13. (VUNESP / TJ-SP - 2023) Considere a seguinte mensagem de correio eletrônico, criada usando 
...
14. (VUNESP / SAME-SP - 2023) Usando o Microsoft Outlook 2016, em sua configuração original, 
...
Ao clicar no ícone para salvar a mensagem, Edson apenas salvou a mensagem em sua Pasta de 
Rascunho. A mensagem não foi enviada para nenhum destinatário. Para enviar a mensagem, Edson 
precisa clicar no ícone para enviar. 
 
Gabarito: Letra E 
 
15. (VUNESP / TJ-SP - 2023) Considere a seguinte mensagem de correio eletrônico, criada usando 
o Microsoft Outlook 365, em sua configuração padrão, de usuários que estão todos na mesma 
empresa e usando seus e-emails corporativos, que foi enviada e recebida com sucesso, para a 
questão.   
...
16. (VUNESP / DPE-SP - 2023) Ricardo preparou e enviou uma mensagem de correio eletrônico 
...
17. (FGV / Câmara de Taubaté-SP – 2022) No contexto de uma instalação padrão das versões mais 
...
18. (FGV / MPE-GO – 2022) No Outlook do pacote MSOffice 2013/2016/2019 BR, Paulo começou a 
...
19. (CESPE / IBAMA – 2022) No Outlook, é possível enviar uma mensagem de forma oculta para o 
...
20. (CESPE / IBAMA – 2022) Na pasta Rascunhos do Outlook, ficam armazenadas as mensagens de 
...
21. (CESPE / ICMBIO – 2022) No MS Outlook, é possível fazer o agendamento de uma atividade 
...
22. (CESPE / IBAMA – 2022) As mensagens da Caixa de Entrada do Outlook, depois de apagadas, 
...
23. (CESPE / APEX-Brasil – 2022) Ao se abrir um arquivo com a extensão ICS (.ics), o Outlook fará 
...
24. (FUNDATEC / IPE-SAÚDE – 2022) O Microsoft Outlook 2016 possui duas formas de responder 
...
25. (FUNDATEC / IPE-SAÚDE – 2022) Quando um e-mail recebido é selecionado no Microsoft 
Outlook 2016: 
...
26. (CESPE / PC-RO – 2022) No programa MS Outlook, para o envio de uma mensagem de e-mail 
...
27. (CESPE / PC-RO – 2022) No MS Outlook, caso o usuário receba uma mensagem enviada para 
...
28. (CESPE / APEX Brasil – 2021) No MS Outlook, para enviar uma mensagem a uma pessoa apenas 
...
29. (CESPE / MPE-AP – 2021) No MS Outlook, é possível juntar um arquivo a uma mensagem de 
...
30. (CESPE / COREN-SE – 2021) No MS Outlook, emails recebidos por uma conta de usuário podem 
...
31. (FCC / Prefeitura de Recife-PE – 2019) Um Assistente Administrativo deseja bloquear 
...
32. (FCC / DETRAN-SP – 2019) Um Oficial de Trânsito que utiliza o Microsoft Outlook 2010, em 
...
33. (FCC / DETRAN-SP – 2019) No Microsoft Outlook 2010, em português, as mensagens de e-mail 
...
34. (VUNESP / CM Piracicaba/SP – 2019) Andréa preparou e enviou uma mensagem de correio 
...
35. (FCC / Prefeitura de São José do Rio Preto-SP – 2019) No Microsoft Outlook 2013, em 
...
36. (VUNESP / SABESP – 2019) No Microsoft Outlook 2013, em português, um Estagiário clicou na 
...
37. (VUNESP / METRO-SP – 2019) Nas versões mais recentes do Microsoft Outlook, após clicar no 
...
38. (VUNESP / Prefeitura de São José do Rio Preto-SP – 2019) Dentre as funcionalidades do 
...
39. (FCC / AFAP – 2019) O webmail é um recurso utilizado para a troca de mensagens via web 
...
40. (FCC / AFAP – 2019) No Microsoft Outlook 2013 em português, um Estagiário recebeu uma 
...
41. (FGV / Prefeitura de Salvador – BA – 2019) Assinale a opção que indica o aplicativo do MS 
...
42. (FCC / SEGEP-MA – 2018) No Microsoft Outlook 2013, em português, a tecla de atalho para se 
...
43. (FGV / AL-RO – 2018) No Microsoft Outlook 2013, em português, compromissos são atividades 
...
44. (FCC / METRÔ-SP – 2018) No Outlook 2013, em português, para mover todas as mensagens 
...
45. (FGV / AL-RO – 2018) Assinale a opção que descreve corretamente o conteúdo da caixa de saída 
...
46. (CESPE / IFF – 2018) No Outlook 2010, a ferramenta que permite ao usuário realizar 
...
47. (CESPE / IFF – 2018) No Outlook 2010, o painel localizado no lado direito que mostra um 
calendário e uma lista de tarefas unificada é conhecido como: 
...
48.(VUNESP / PREF SERTÃOZINHO - 2018) Considere a figura a seguir, extraída do MS-Outlook 
...
49. (FGR / PREF CABECEIRA GRANDE - MG – 2018) Para se anexar um arquivo em uma mensagem 
...
50. (VUNESP / PREF SERTÃOZINHO – 2018) Um usuário que usa o campo Cco do MS-Outlook 
...
51. (VUNESP / PREF SUZANO – 2018) No MS-Outlook 2010, em sua configuração padrão, um uso 
...
52. (VUNESP / CM 2 CÓRREGOS - 2018) Observe a lista de mensagens eletrônicas na Caixa de 
...
53. 
(VUNESP / CM INDAIATUBA – 2018) Observe as pastas de e-mail a seguir, extraídas do MS-
...
54. (VUNESP / IPSM SJC - 2018) Um usuário preparou e enviou uma mensagem de correio 
...
55. (VUNESP / IPSM SJC - 2018) A imagem a seguir, retirada do MS-Outlook 2010, em sua 
...
56. (AOCP / PM-TO – 2018) Considerando o Microsoft Outlook 2013, versão em português, em sua 
...
57. (VUNESP / PREF BARRETOS - 2018) Gustavo preparou uma mensagem de correio eletrônico 
...
58. (FCC / TRT2 – 2018) No Microsoft Outlook 2013, em português, após clicar na opção Novo Email 
...
59. (VUNESP / CM SUMARÉ - 2017) Um usuário, por meio do MS-Outlook 2010, em sua 
...
60. (VUNESP / IPRESB – 2017) Assinale a alternativa correta sobre correio eletrônico, 
...
61. (FCC / TRT-24 Região – 2017) Um Oficial de Justiça deseja definir regras para o Microsoft 
...
62. (VUNESP / CM VALINHOS – 2017) No programa de correio eletrônico Outlook 2010, em sua 
...
63. (VUNESP / CM SUMARÉ - 2017) Um usuário, por meio do MS-Outlook 2010, em sua 
configuração padrão, deseja enviar o mesmo e-mail para dois destinatários ao mesmo tempo, 
de modo que ambos possam ver todos os destinatários do e-mail. Assim sendo, ele coloca um 
dos endereços de destinatário no campo Para, e o outro endereço de destinatário é colocado no 
campo ______________. 
...
64. (VUNESP / Câmara de Mogi das Cruzes - SP – 2017) O usuário João saiu de férias e configurou 
...
65. (CESPE / TCE-PA – 2016) No Outlook, se a opção Com cópia oculta (Cco) estiver ativada durante 
...
66. 
(VUNESP / CM REGISTRO – 2016) Um usuário do MS-Outlook 2010, em sua configuração 
...
67. (VUNESP / PREF ALUMÍNIO – 2016) Um usuário preparou uma mensagem de correio 
...
68. 
(VUNESP / CM PRADÓPOLIS – 2016) Um usuário que queira enviar, por meio do MS-
Outlook 2010, em sua configuração padrão, o mesmo e-mail, ao mesmo tempo, para vários 
...
69. 
(VUNESP / PREF PRESIDENTE PRUDENTE – 2016) Um usuário, ao redigir um novo e-mail, 
...
70. (VUNESP / CM GUARATINGUETÁ – 2016) Um recurso muito útil do MS-Outlook 2010, em sua 
...
71. (VUNESP / CM POÁ – 2016) A imagem a seguir foi retirada do MS-Outlook 2010, em sua 
...
72. (VUNESP / PREF SERTÃOZINHO – 2016) Considere a preparação de um e-mail no Outlook 
...
73. (PUC-PR / PARANACIDADE – 2016) Na instalação padrão do programa Microsoft Outlook 
2013, ao iniciar o programa, tem-se na Barra de Ferramentas de Acesso Rápido e na Guia 
Enviar/Receber o botão 
. Assinale a alternativa CORRETA que representa a função deste 
...
74. (PUC-PR / PARANACIDADE – 2016) O software Microsoft Outlook 2013, instalado de forma 
...
75. (PUC-PR / PARANACIDADE – 2016) Na instalação padrão no Windows do Microsoft Outlook 
...
76. (IBFC / CM Franca - 2016) No MS-Outlook pode-se recuperar um e-mail que possa ter sido 
...
77. (AOCP / CISAMUSEP – 2016) Você utiliza o Microsoft Outlook 2013 em seu computador. Ao 
...
78. (FCC / Eletrobrás – 2016) É possível fazer o download de mensagens de uma conta de webmail 
...
79. (CESPE / DPU – 2016) No Microsoft Outlook 2013, desde que configurado adequadamente, um 
...
80. (CESPE / TCE-PA – 2016) No Outlook, se a opção Com cópia oculta (Cco) estiver ativada durante 
...
81. (VUNESP / Prefeitura de São José do Rio Preto – 2015) Assinale a alternativa que contém o 
...
82. (VUNESP / CRO-SP – 2015) Um exemplo de aplicativo específico de correio eletrônico é o MS-
...
83. (CONSULPLAN / CBTU – 2014) Considere a imagem do aplicativo de correio eletrônico 
...
84.(CESPE / MTE – 2014) No Microsoft Outlook 2013, o cartão de visita reúne os principais detalhes 
...
85. (IBFC / SDH PR – 2013) Quando uma mensagem é excluída, no MS-Outlook, ela é movida para 
...
86. 
(CESPE / FUB – 2013) É possível incluir no Microsoft Outlook uma assinatura digital, que 
pode ser composta de texto, imagens e até uma imagem de assinatura manuscrita. Essa 
assinatura é utilizada para conferir os dados do usuário quando ele se identifica, mediante login, 
para acessar esse sistema de email. 
...
87. (CEFET-BA / CREF/13ª – 2012) Existem diversas formas de acesso a uma caixa postal de e-mails. 
...
88. 
(OBJETIVA / Prefeitura de Chapecó/SC – 2011) Considerando o Outlook Express, assinalar 
a alternativa que preenche CORRETAMENTE a lacuna abaixo: 
...
89. 
(CESPE / STM – 2011) Caso o usuário tenha uma lista de contatos de email em uma planilha 
...
90. (FGV / COMPESA – 2014) Com relação aos arquivos do MSOffice Outlook 2010 BR, analise as 
...
91. (FGV / COMPESA – 2014) No MS Office Outlook 2010 BR, o acionamento da tecla de função F9 
...
92. (FGV / FBN – 2013) Mensagens de e-mail recebidas da Internet pelo Outlook Express 6, são 
...
93. (FGV / PC-MA – 2012) Um funcionário usando o Outlook Express 6 recebeu de seu supervisor 
...
94. (CESGRANRIO / BB – 2012) O uso de correio eletrônico é normalmente efetuado por meio de 
clientes de e-mail, como o Outlook Express da Microsoft, ou por meio de webmails, ferramentas 
disponibilizadas pelos provedores de internet em seus sites. Considerando como exemplo o 
programa da Microsoft, verifica-se que uma diferença entre essas ferramentas disponibilizadas 
pelos provedores e o programa Outlook Express consiste no fato de que nele: 
...
95. (CESGRANRIO / PETROBRAS – 2011) No uso dos recursos da Internet, é comum ocorrer a 
...
96. 
(CESGRANRIO / EPE – 2010) Qual o procedimento para escrever um e-mail usando o 
OUTLOOK 2007? 
...
97. (CESGRANRIO / EPE – 2010) No Outlook 2007, os e-mails encontram-se organizados em 
...
Caixa de Saída. Quando ele é efetivamente enviado ao destinatário, ele fica na Itens Enviados. 
 
Gabarito: Letra B 
 
98. 
(UPENET-IAUPE / SUAPE – 2010) Depois de redigir completamente uma mensagem e clicar 
...
99. 
(IDECAN / FUNTELPA – 2010) Sobre a utilização do gerenciador de correio Microsoft 
Outlook (versão 2007 – configuração padrão), analise:  
...
100. (CESGRANRIO / PETROBRAS – 2010) Mensagens de correio eletrônico podem ser enviadas 
...
101. (CESGRANRIO / IBGE – 2009) Por padrão, as mensagens recebidas com prioridade alta pelas 
...
102. (CESGRANRIO / SECAD-TO – 2009) A tela a seguir está sendo utilizada para criar uma 
...
103. (FGV / Senado Federal – 2008) Ao usarmos o Outlook para enviar uma mensagem de correio 
...
104. (CESGRANRIO / INSS – 2005) O endereço do servidor através do qual o Outlook 2000 envia 
...
1. (CESPE / MPO – 2024) O Mozilla Thunderbird possibilita que o usuário carregue seus e-mails em 
abas separadas e permite que, se fechado, as abas visíveis sejam salvas e, assim, restauradas na 
próxima vez em que o aplicativo for executado. 
 
Comentários: 
 
Correto. O Mozilla Thunderbird permite que os e-mails sejam abertos em abas separadas, 
facilitando a navegação. Além disso, quando fechado, ele pode salvar as abas abertas e restaurá-
las na próxima inicialização, garantindo continuidade no uso. 
 
Gabarito: Correto 
 
2. (CESPE / CBM-TO – 2023) O Mozilla Thunderbird, nas versões mais recentes, possui um recurso 
chamado Agrupar tópicos, o qual coloca conversas de email juntas hierarquicamente, de forma 
a mantê-las em listas de email organizadas. Caso esse recurso não esteja ativado, o usuário 
poderá iniciar sua ativação por meio do menu , mediante a opção: 
...
(a) Errado. "Arquivo" geralmente contém opções relacionadas a gerenciamento de arquivos, como 
salvar, abrir, e fechar, mas não costuma incluir configurações de visualização de e-mails. 
 
(b) Errado. "Ferramentas" é mais associado a ajustes de configurações gerais e extensões do 
programa, não especificamente à organização de visualização de e-mails. 
 
(c) Correto. "Exibir" é o menu que contém opções para alterar a maneira como os itens são exibidos 
no programa, incluindo a organização e agrupamento de e-mails.  
 
(d) Errado. "Editar" está mais relacionado a funções de edição de texto e preferências do programa, 
e não é comumente utilizado para configurações de visualização de e-mails. 
 
Gabarito: Letra C 
 
3. (CESGRANRIO / UNIRIO – 2019) Um cliente de correio-eletrônico, como o Mozilla Thunderbird, 
...
(a) Correto. IMAP é projetado para sincronizar e-mails entre o cliente de e-mail e o servidor e 
permite que ações realizadas no cliente sejam replicadas no servidor, e vice-versa; 
 
(b) Errado. NNTP é usado para a distribuição, consulta e postagem de artigos nos grupos de notícias 
Usenet e não está relacionado ao e-mail; 
 
(c) Errado. POP3 é um protocolo de e-mail que permite baixar mensagens do servidor para o cliente 
local, mas não sincroniza as ações de leitura ou organização de volta ao servidor; 
 
(d) Errado. SMTP é usado para o envio de e-mails, mas não para a sincronização ou armazenamento 
de e-mails no servidor; 
 
(e) Errado. TCP/IP é um conjunto de protocolos de rede e não está diretamente relacionado ao 
funcionamento de clientes de e-mail. 
 
Gabarito: Letra A 
 
4. (FGV / AL-RO – 2018) No correio eletrônico Thunderbird Mozilla, "Assinaturas" são blocos de 
...
5. (FGV / AL-RO – 2018) Pedro quer anexar seu nome, endereço e telefone às mensagens 
...
6. (FGV / AL-RO – 2018) Mensagens eletrônicas com anexos grandes são, muitas vezes, rejeitadas 
...
7. (CESPE / TRT-7 Região – 2017) No que tange aos recursos do programa de correio eletrônico 
...
8. (CESPE / TRT/ 7 – 2017) No que tange aos recursos do programa de correio eletrônico Mozilla 
...
9. (CESPE / CBM-AL – 2017) Para o envio de um e-mail a mais de um destinatário, por meio do 
...
10. (COMPERVE / Prefeitura de Ceará-Mirin/RN – 2016) O aplicativo Mozilla Thunderbird permite 
...
11. (CESPE / FUB – 2016) No catálogo de endereços das versões mais recentes do Mozilla 
...
12. (VUNESP / UNESP – 2016) Assinale a alternativa que contém somente os objetos da biblioteca 
...
13. (VUNESP / UNESP – 2016) Assinale a alternativa que contém apenas campos de e-mail usados 
...
14. (FGV / DPE-RO – 2015) Você é solicitado a instalar, em uma estação de trabalho, um software 
...
15.  (VUNESP / Polícia Civil  – 2015) A imagem a seguir foi extraída do Thunderbird 24.4.0 em sua 
...
16. (IBFC / TRE-AM – 2014) Para o correto envio de mensagens pelo Outlook Express e o Mozilla 
...
17. (CESPE / TC-DF – 2014) Funcionalidades disponibilizadas no Mozilla Thunderbird possibilitam 
...
18. (CESPE / CBM-CE – 2014) Em comparação ao Microsoft Outlook, o Mozzilla Thunderbird tem a 
...
19. (CESPE / Polícia Federal – 2014) Se um usuário do Mozilla Thunderbird receber e-mail de 
...
20. (VUNESP / FUNDUNESP – 2014) Observe a figura a seguir, extraída do ThunderBird, em sua 
...
21. (CESPE / CADE – 2014) O Mozilla Thunderbird permite que cada conta de email tenha o seu 
...
22. (CESPE / CADE – 2014) O recurso do Mozilla Thunderbird que permite agrupar e ordenar 
...
23. (CESPE / MTE – 2014) Por padrão, durante a inicialização do aplicativo, ocorre uma verificação 
...
24. (CESPE / TRE-MS – 2013) A figura abaixo ilustra uma lista que é exibida, no aplicativo para uso 
...
25. (FGV / AL-MT – 2013) A figura 1 a seguir ilustra uma janela que é mostrada na tela para edição 
...
26. (FGV / CONDER – 2013) O software Thunderbird Mozilla possui a seguinte funcionalidade: 
...
27. (CESPE / TJAC – 2012) O Mozilla Thunderbird 16 possui arquivamento de mensagem sem retirá-
...
28. (CESPE / CBM-DF – 2011) Quando se usa o software Mozilla Thunderbird, a leitura de 
...
29. (FGV / BADESC – 2010) Existem, pelo menos, duas maneiras de se gerenciar o acesso às 
...
7. (CESGRANRIO / BB – 2021) O envio e o recebimento de mensagens de correio eletrônico são 
...
8. (CESGRANRIO / BB – 2021) O serviço de correio eletrônico é uma ferramenta essencial para o 
...
30. (CESGRANRIO / BB – 2015) O gerente de uma agência recebeu um e-mail, supostamente 
...
36. (CESGRANRIO / BB – 2014) Qual arquivo que, por questões de segurança, não pode ser enviado 
