...
entre eles são intercaladas outras estruturas, de modo que, muitas vezes, teremos diﬁculdade de 
...
Então, em uma “regra prática”, o sujeito é o termo que “conjuga” o verbo, justiﬁca o verbo estar 
...
(numerais, verbo no inﬁnitivo...). Esse núcleo recebe termos que o “especiﬁcam”, “delimitam”: 
...
Observe que, como regra, o verbo se ﬂexiona para concordar em número e pessoa com o núcleo 
do sujeito.  
O restante da sentença foi a ‘declaração’ feita sobre o sujeito, o que chamamos de predicado. 
Aliás, essa palavra ”predicado” signiﬁca exatamente isto: característica atribuída a um ser; 
atributo, propriedade. 
Aprofundaremos essas análises mais a frente, no estudo de cada função sintática.  
Voltando ao sujeito, faço um alerta quanto à identiﬁcação desse termo:  
...
1) Localize o verbo. 
2) Identiﬁque a pessoa (1ª, eu, nós; 2ª, tu, vós; 3ª, ele(a), eles(a)) e o número do verbo 
(singular/plural). 
3) Localize o sujeito (geralmente, o “quem” do verbo e que com ele concorda em pessoa 
e número). 
Passaremos agora ao estudo do sujeito e suas diversas formas e classiﬁcações. Esse termo é 
essencial, pois é a função sintática mais cobrada. 
 
Sujeito Determinado 
O sujeito determinado é aquele que está identiﬁcado, visível no texto, sabemos exatamente 
...
núcleo desse sujeito é o verbo no inﬁnitivo “exportar”. Quando o sujeito é oracional, o verbo ﬁca 
...
“mandei” é a oração: “o menino sair”, que está numa forma de oração reduzida de inﬁnitivo, 
...
limitados em situações especíﬁcas: o direito à liberdade pode ser restringido se, após o devido 
...
direitos humanos —, mas (Os direitos humanos) podem ser limitados em situações especíﬁcas 
O referente é “Os direitos humanos”. Gabarito letra E.  


Sujeito Oculto / Elíptico / Desinencial 
O sujeito oculto é determinado, pois podemos identiﬁcá-lo facilmente pelo contexto ou pela 
...
identiﬁcar no período. Não sabemos exatamente quem é o sujeito e não conseguimos inferir do 
contexto.  
...
na oração, ele pode ser identiﬁcado pela terminação do verbo ou pelo contexto. 
Com o sujeito indeterminado, isso não acontece, pois o contexto não é suﬁciente 
...
sujeito-PIS). 
Ex: Desconﬁa-se de que ela seja violenta. 
 
      Verbo Trans. Indireto + SE (Quem desconﬁa? Não se sabe...) 
...
todos fazem, mas sem individualizar um agente em especíﬁco. Veja: 
...
Ex: Sempre se ﬁca nervoso durante um assalto. 
 
  Verbo de Ligação + SE (Em geral, todos ﬁcam nervosos durante um assalto, temos um 
sujeito indeterminado, um agente universal, genérico, não especíﬁco). 
...
verbo transitivo INDIRETO. Se o termo não é o sujeito, então não vai fazer o verbo se ﬂexionar. 
Logo, o verbo ﬁca na terceira pessoa do singular.  
...
+ SE, o verbo vai se ﬂexionar para concordar com o sujeito (paciente), como na frase abaixo: 
...
do texto. 
Comentários:  
“Tratar-se DE” é expressão invariável, que conﬁgura sujeito indeterminado “Verbo Transitivo 
Indireto+SE”. Logo, o verbo não vai ao plural. Questão incorreta.  


Indeterminação do sujeito pelo uso do inﬁnitivo impessoal: 
No caso de indeterminação do sujeito pelo uso de um verbo no inﬁnitivo, por não haver 
concordância com nenhuma pessoa, a ação verbal é descrita de maneira vaga, sem revelar o 
agente que pratica a ação. Veja: 
Ex: Praticar esportes regularmente é muito importante. (o agente é genérico, indeﬁnido; 
...
Se o verbo no inﬁnitivo estiver ﬂexionado, então estará fazendo concordância com um sujeito 
visível na sentença. Nesse caso, não há sujeito indeterminado.  
Ex: É necessário passarmos por aquele caminho. (Aqui, a ﬂexão do inﬁnitivo “denuncia” o 
...
direto” de “haver” (verbo impessoal), por isso não há ﬂexão. O objeto direto não faz o verbo se 
ﬂexionar (ir ao plural), isso é papel do sujeito.  
Por outro lado, na oração “existem pessoas ruins no mundo”, o termo “pessoas ruins no mundo” 
é sujeito do verbo “existir” (verbo pessoal, com sujeito), por isso há ﬂexão. 
...
Se o verbo for pessoal, como “existir”, aí o verbo auxiliar se ﬂexiona normalmente:  
...
nas minhas costas, Doutor” também são classiﬁcadas como orações sem sujeito.  
...
(TRT-MT / 2016)  
...veriﬁca-se a existência de matas e de estradas rurais em condições ruins ou onde é necessário o 
...
que retoma um objeto direto já existente na oração, com ﬁnalidade de ênfase.  
...
Ex: Eu sempre vivi uma vida de grandes desaﬁos. 
...
classiﬁcados como Verbos Intransitivos que podem vir seguidos de um adjunto adverbial. 
...
✔ Quando o objeto direto for verbo no inﬁnitivo, com os verbos “ensinar” e “aprender”: 


 
Ex: Meu irmão tentou me ensinar a surfar, mas nem aprendi a nadar.  (“Surfar” é objeto 
direto de “ensinar”; “nadar” é o objeto direto do verbo “aprendi” e, por estar no inﬁnitivo, a 
...
ou tradição.  
✔ Com alguns pronomes indeﬁnidos, sobretudo referentes a pessoas: 
...
Ex: Fizeram sorrir, sem diﬁculdade, a Tamires. 
...
pronome indeﬁnido “todos” como objeto direto, acrescentamos a preposição, constituindo um 
...
(TRT-MT / 2016)  
Ademais, em segundo plano, tal atribuição ﬁscalizatória advém dos preceitos morais que impõem 
...
classiﬁcação no que se refere à transitividade. 
Comentários: 
Nós classiﬁcamos os verbos quanto à transitividade de acordo com o complemento verbal que 
...
“Impor” é VTD. “Dispor” é VTI. Logo, esses verbos não têm a mesma classiﬁcação. Questão 
incorreta. 
Complemento Nominal 
...
Ex: O cão sentia falta de brincar. (Aqui, a oração está reduzida de inﬁnitivo)   
Ex: João tinha consciência de que precisava passar. 
Ex: João tinha consciência de precisar passar. (Aqui, a oração está reduzida de inﬁnitivo). 
 
Adjunto Adnominal 
Termo que acompanha substantivos concretos e abstratos para atribuir-lhes características, 
qualidade ou estado. Os adjuntos adnominais têm função adjetiva, ou seja, modiﬁcam termo 
substantivo. 
 
Ex: Os três carros populares do meu pai foram carregados pela chuva.  
             Núcleo 
Os termos destacados são adjuntos adnominais, pois ﬁcam junto ao nome “carros” e atribuem a 
...
Na verdade, esses dois termos são bem diferentes! Há um único caso em que ﬁcam parecidos e 
...
Semelhanças: 
Essas duas funções sintáticas, CN e AA, só ﬁcam parecidas em um caso: substantivo abstrato 
...
há dúvida, é complemento nominal. Para conﬁrmar isso, observe que o sentido é passivo, pois “a 
saúde é prejudicada".  
Já “da mulher” se liga ao substantivo “saúde”, que é abstrato. A mulher é agente, tem a saúde e 
há claro sentido de posse; então, temos um adjunto adnominal. Para conﬁrmar isso, poderíamos 
...
As pessoas da família nem sempre são favoráveis ao trabalho dos ﬁlhos. 
...
“dos ﬁlhos” é termo preposicionado ligado a substantivo abstrato, trabalho (ação). Então, 
poderia ser CN ou Adjunto. Tiramos a dúvida pelo teste do agente/paciente: os ﬁlhos trabalham, 
...
Se ﬁcar a dúvida, veja se o sentido do termo preposicionado é agente ou paciente. Esse deve ser 
o último critério.  
...
conceito). 
Só modiﬁca substantivo: Então, termo 
preposicionado 
ligado 
a 
adjetivo 
...
Comentários: 
Em "professora de psicologia", o termo "de psicologia" é um especiﬁcador de tipo, na forma de 
...
O termo preposicionado “de gênero” não possui sentido passivo, é uma especiﬁcação, apenas 
um adjunto adnominal de “justiça”. Questão incorreta.  
Predicativo do Sujeito 
É a qualiﬁcação/estado/caracterização que se atribui ao sujeito, normalmente por via de um 
verbo de ligação: ser; estar; permanecer; ﬁcar; continuar; tornar-se; andar; virar; continuar. 
...
Ex: Mesmo celebridades ﬁcam nervosas diante da mídia. (Predicativo na forma de adjetivo) 
...
Qualiﬁcação/estado que se atribui ao objeto, por via de alguns verbos especíﬁcos (verbos 
...
vista como inerente e deﬁnitiva.  
...
a característica é inerente, deﬁnitiva; não é atribuída a ela por um sujeito). 
Sintaticamente, para identiﬁcar a diferença entre um predicativo do objeto e um adjunto 
adnominal, devemos substituir o objeto direto por um pronome (o, a, os , as) e veriﬁcar se o 
...
signiﬁca que o adjetivo permaneceu sempre “junto ao nome”, o que conﬁrma sua função 
...
Tipos de Predicado 
Agora que sabemos reconhecer um predicativo, ﬁca bem mais fácil conhecer o predicado e seus 
tipos.  
...
Ex: João comprou um riﬂe. (predicado verbal, verbo de ação “comprar”, transitivo direto) 
...
SEMPRE por um verbo de ligação (verbos de estado: ser, estar, ﬁcar, permanecer, parecer, 
continuar, andar...). 
...
estável e movediça. Como vimos, isso conﬁrma a função de adjunto adnominal.  
...
pode ser especiﬁcativo, quando especiﬁca o referente dentro de um universo.  
...
Ex: O pior desaﬁo, o da mudança, acaba sendo vencido. 
...
OBS: O aposto “especiﬁcativo” não vem separado por pontuação e individualiza o seu referente. 
Sua forma mais comum se conﬁgura em um nome próprio especiﬁcando um substantivo comum.  
Veja: 
...
Adjunto Adnominal X Aposto Especiﬁcativo 
── Ah, professor! Por que não posso dizer que “da Pipa” é um adjunto adnominal? 
── Porque não há valor adjetivo nem de posse. Veja: 
O aposto especiﬁcativo “nomeia”. “Pipa” é a própria praia, não é que uma “Pipa” tem uma 
...
comerciais e se alcança o resultado último dessa interatuação: o preço eﬁciente dos bens e 
serviços. 
...
esclarecimento. O termo “o preço eﬁciente dos bens e serviços” é justamente o esclarecimento 
...
iconoclasta”, haveria mudança do signiﬁcado original do texto, mas as funções sintáticas de 
...
Adj 
O aposto especiﬁcativo tradicionalmente aparece na forma de um nome próprio substituindo o 
um nome comum. Então, notamos que “Oscar Wilde” é um aposto especiﬁcativo do substantivo 
comum “iconoclasta”. 
No segundo caso (Oscar Wilde iconoclasta), “Oscar Wilde” é núcleo substantivo, sendo 
modiﬁcado pelo adjetivo “iconoclasta”, com função de adjunto adnominal.  
Então, a inversão causa mudança sintática, pois no aposto especiﬁcativo, o nome próprio vem 
depois do comum, que está sendo especiﬁcado.  
Outros exemplos de aposto especiﬁcativo, que pode ser preposicionado ou não: Praia de 
Copacabana; Meu ﬁlho Pedro; Crime de latrocínio; O cantor Renato Russo. Questão incorreta. 
Adjunto Adverbial 
É a função sintática do termo que modiﬁca o verbo, trazendo uma ideia de circunstância, como 
...
um termo indicar a circunstância de um verbo, especiﬁcar a forma como aquele verbo é 
...
inteira.  
Ex: Ela é muito bonita. (“muito” é um advérbio usado para “intensiﬁcar” o adjetivo 
...
“intensiﬁcar” o advérbio “provavelmente”; sua função sintática é de adjunto adverbial) 
...
circunstância de condição, causa, tempo, ﬁnalidade etc.  
...
Observe que fatores como o tipo de verbo, a pontuação ou ausência dela pode inﬂuenciar na 
...
O menino fez o pai rico. (predicativo do objeto – "o pai" -objeto- "ﬁcou rico") 
...
(TRT-MT / 2016)  
“A par disso, quando se pensa no processo eleitoral — embora logo venha à cabeça a ﬁgura dos 
...
“Ademais, em segundo plano, tal atribuição ﬁscalizatória advém dos preceitos morais que 
...
identiﬁcação de embarcações denominado automatic identiﬁcation system, um sistema de 
...
Ex: Socorro! / Deus lhe pague / Você está sendo ﬁlmado / Morra! 
